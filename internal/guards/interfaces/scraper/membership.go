...
// logged-in player to the kiosk for the match they're in. Alias of
// manager.ContainerMembership (moved in step 7 part 3c with the match
// helpers below; type identity preserved).
type ContainerMembership = manager.ContainerMembership
...
var SanitizeIdentity = manager.SanitizeIdentity
...
var MatchContainer = manager.MatchContainer
...
var ContainerHasGamertag = manager.ContainerHasGamertag

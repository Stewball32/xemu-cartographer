...
// New creates a Halo 2 GameReader for the given instance, reading all address
...
func init() {
	scraper.Register(TitleID, "halo2", func(inst *xemu.Instance, instanceName string, set *offsets.Set) (scraper.GameReader, error) {

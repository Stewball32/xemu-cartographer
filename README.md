...
> **For AI assistants:** See [CLAUDE.md](CLAUDE.md) for development commands, conventions, and implementation details, and [docs/](docs/README.md) for project status, milestones, and decisions.

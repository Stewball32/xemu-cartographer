...
- [ ] [M18 — Rating system + leaderboards](milestones/M18-rating-leaderboards.md) — **in progress** (`wip/milestone-18`). Elo rating + leaderboard ranking (`internal/rating`) landed (unit-tested). Per-game-type hook, leaderboard pages, Discord cmds deferred.

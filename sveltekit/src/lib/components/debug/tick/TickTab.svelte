<script lang="ts">
	...
	const payload = $derived(scraperWSV2.tick[name] ?? null);
	const envelope = $derived(scraperWSV2.tickEnvelope[name] ?? null);
</script>

<div class="flex flex-col gap-4">
	<TickStatsHeader {envelope} {viewMode} onViewModeChange={setViewMode} />

// Tree-View node collection + JSON-scoping helpers for the Objects debug tab's
...
export function buildTreeRoot(env: EnvelopeV2<ObjectsPayload> | null): XNode {
 ...
 *                              e.g. selecting 'data.objects' yields
 *                              { data: { objects: [...] } } regardless of
 *                              whether the selected node is a branch or
 *                              a leaf. JSON.stringify renders this with
 *                              standard pretty-print.
 */
export function scopeAtPath(
	env: EnvelopeV2<ObjectsPayload> | null,

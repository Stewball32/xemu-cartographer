					...
					<Popover.Positioner class="z-50!">
						...
						>
							...
							<a
								...
								class="mt-1 flex items-center gap-2 rounded-base px-3 py-2 hover:preset-tonal"
							>
							...
							<button
								type="button"
								class="flex w-full items-center gap-2 rounded-base px-3 py-2 text-left hover:preset-tonal"
								onclick={() => auth.logout()}
							>
